...
This report indexes actual checks and independent reviews for the private engineering/text handoff. The full overhaul is not accepted: native depth-three orchestration and mandatory art are missing. See `findings.json` for every named review finding and its disposition chain, and the generated final report for requirement states.
...
| Art/native model |72 art families /115 exports absent; seven recorded depth 1 leads; no Astra art author or depth 3 chain | Exact jobs blocked; no fallback or provider attestation |
