...
- `site/visual-regression-baselines/`
...
## Required checks
- No placeholder or unavailable primary destinations.
- Keyboard/mobile/light/dark/reduced-motion states are inspected.
- Synthetic fixtures cannot enter the production export.
